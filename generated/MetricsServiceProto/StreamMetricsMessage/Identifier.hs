{-# LANGUAGE BangPatterns, DataKinds, DeriveDataTypeable, DeriveGeneric, FlexibleInstances, MultiParamTypeClasses, OverloadedStrings
 #-}
{-# OPTIONS_GHC  -w #-}
module MetricsServiceProto.StreamMetricsMessage.Identifier (Identifier(..)) where
import Prelude ((+), (/), (++), (.))
...
instance P'.ReflectDescriptor Identifier where
  ...
  reflectDescriptorInfo _
   = Prelude'.read
      "DescriptorInfo {descName = ProtoName {protobufName = FIName \".envoy.service.metrics.v3.StreamMetricsMessage.Identifier\", haskellPrefix = [], parentModule = [MName \"MetricsServiceProto\",MName \"StreamMetricsMessage\"], baseName = MName \"Identifier\"}, descFilePath = [\"MetricsServiceProto\",\"StreamMetricsMessage\",\"Identifier.hs\"], isGroup = False, fields = fromList [FieldInfo {fieldName = ProtoFName {protobufName' = FIName \".envoy.service.metrics.v3.StreamMetricsMessage.Identifier.node\", haskellPrefix' = [], parentModule' = [MName \"MetricsServiceProto\",MName \"StreamMetricsMessage\",MName \"Identifier\"], baseName' = FName \"node\", baseNamePrefix' = \"\"}, fieldNumber = FieldId {getFieldId = 1}, wireTag = WireTag {getWireTag = 10}, packedTag = Nothing, wireTagLength = 1, isPacked = False, isRequired = False, canRepeat = False, mightPack = False, typeCode = FieldType {getFieldType = 11}, typeName = Just (ProtoName {protobufName = FIName \".envoy.config.core.v3.Node\", haskellPrefix = [], parentModule = [MName \"BaseProto\"], baseName = MName \"Node\"}), hsRawDefault = Nothing, hsDefault = Nothing, isMapField = False, mapKeyVal = Nothing}], descOneofs = fromList [], keys = fromList [], extRanges = [], knownKeys = fromList [], storeUnknown = False, lazyFields = False, makeLenses = False, jsonInstances = False, mapEntry = False}"
