...
module Proto.Envoy.Service.Runtime.V3.Rtds_Fields where
...
maybe'layer ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'layer" a) =>
  Lens.Family2.LensLike' f s a
maybe'layer = Data.ProtoLens.Field.field @"maybe'layer"
name ::
  forall f s a.
