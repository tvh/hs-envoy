...
module Proto.Envoy.Service.LoadStats.V3.Lrs_Fields where
...
clusterStats ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "clusterStats" a) =>
  Lens.Family2.LensLike' f s a
clusterStats = Data.ProtoLens.Field.field @"clusterStats"
clusters ::
  forall f s a.
  (Prelude.Functor f,
...
loadReportingInterval ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "loadReportingInterval" a) =>
  Lens.Family2.LensLike' f s a
loadReportingInterval
  = Data.ProtoLens.Field.field @"loadReportingInterval"
maybe'loadReportingInterval ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'loadReportingInterval" a) =>
  Lens.Family2.LensLike' f s a
maybe'loadReportingInterval
...
reportEndpointGranularity ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "reportEndpointGranularity" a) =>
  Lens.Family2.LensLike' f s a
reportEndpointGranularity
...
sendAllClusters ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "sendAllClusters" a) =>
  Lens.Family2.LensLike' f s a
sendAllClusters = Data.ProtoLens.Field.field @"sendAllClusters"
vec'clusterStats ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "vec'clusterStats" a) =>
  Lens.Family2.LensLike' f s a
vec'clusterStats = Data.ProtoLens.Field.field @"vec'clusterStats"
vec'clusters ::
  forall f s a.
  (Prelude.Functor f,
