...
module Proto.Envoy.Service.Metrics.V3.MetricsService_Fields where
...
envoyMetrics ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "envoyMetrics" a) =>
  Lens.Family2.LensLike' f s a
envoyMetrics = Data.ProtoLens.Field.field @"envoyMetrics"
identifier ::
  forall f s a.
  (Prelude.Functor f,
...
vec'envoyMetrics ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "vec'envoyMetrics" a) =>
  Lens.Family2.LensLike' f s a
vec'envoyMetrics = Data.ProtoLens.Field.field @"vec'envoyMetrics"