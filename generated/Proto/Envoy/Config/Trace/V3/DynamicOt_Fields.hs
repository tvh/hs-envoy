...
module Proto.Envoy.Config.Trace.V3.DynamicOt_Fields where
...
library ::
  forall f s a.
  (Prelude.Functor f, Data.ProtoLens.Field.HasField s "library" a) =>
  Lens.Family2.LensLike' f s a
library = Data.ProtoLens.Field.field @"library"
maybe'config ::
  forall f s a.
  (Prelude.Functor f,
