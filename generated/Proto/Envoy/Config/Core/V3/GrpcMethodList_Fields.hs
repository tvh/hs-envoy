...
module Proto.Envoy.Config.Core.V3.GrpcMethodList_Fields where
...
methodNames ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "methodNames" a) =>
  Lens.Family2.LensLike' f s a
methodNames = Data.ProtoLens.Field.field @"methodNames"
name ::
  forall f s a.
...
vec'methodNames ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "vec'methodNames" a) =>
  Lens.Family2.LensLike' f s a
vec'methodNames = Data.ProtoLens.Field.field @"vec'methodNames"
vec'services ::
  forall f s a.
  (Prelude.Functor f,
