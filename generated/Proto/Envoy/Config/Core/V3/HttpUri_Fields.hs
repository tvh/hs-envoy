...
module Proto.Envoy.Config.Core.V3.HttpUri_Fields where
...
maybe'httpUpstreamType ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'httpUpstreamType" a) =>
  Lens.Family2.LensLike' f s a
maybe'httpUpstreamType
  = Data.ProtoLens.Field.field @"maybe'httpUpstreamType"
maybe'timeout ::
  forall f s a.
  (Prelude.Functor f,
