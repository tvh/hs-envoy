...
module Proto.Envoy.Config.Metrics.V3.MetricsService_Fields where
...
emitTagsAsLabels ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "emitTagsAsLabels" a) =>
  Lens.Family2.LensLike' f s a
emitTagsAsLabels = Data.ProtoLens.Field.field @"emitTagsAsLabels"
grpcService ::
  forall f s a.
  (Prelude.Functor f,
...
maybe'reportCountersAsDeltas ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'reportCountersAsDeltas" a) =>
  Lens.Family2.LensLike' f s a
maybe'reportCountersAsDeltas
...
reportCountersAsDeltas ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "reportCountersAsDeltas" a) =>
  Lens.Family2.LensLike' f s a
reportCountersAsDeltas
  = Data.ProtoLens.Field.field @"reportCountersAsDeltas"
transportApiVersion ::
  forall f s a.
  (Prelude.Functor f,
