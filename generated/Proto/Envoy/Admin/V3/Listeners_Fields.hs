...
module Proto.Envoy.Admin.V3.Listeners_Fields where
...
listenerStatuses ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "listenerStatuses" a) =>
  Lens.Family2.LensLike' f s a
listenerStatuses = Data.ProtoLens.Field.field @"listenerStatuses"
localAddress ::
  forall f s a.
  (Prelude.Functor f,
...
vec'listenerStatuses ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "vec'listenerStatuses" a) =>
  Lens.Family2.LensLike' f s a
vec'listenerStatuses
