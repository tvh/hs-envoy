{- This file was auto-generated from envoy/type/matcher/regex.proto by the proto-lens-protoc program. -}
{-# LANGUAGE ScopedTypeVariables, DataKinds, TypeFamilies, UndecidableInstances, GeneralizedNewtypeDeriving, MultiParamTypeClasses, FlexibleContexts, FlexibleInstances, PatternSynonyms, MagicHash, NoImplicitPrelude, DataKinds, BangPatterns, TypeApplications, OverloadedStrings, DerivingStrategies#-}
{-# OPTIONS_GHC -Wno-unused-imports#-}
{-# OPTIONS_GHC -Wno-duplicate-exports#-}
{-# OPTIONS_GHC -Wno-dodgy-exports#-}
module Proto.Envoy.Type.Matcher.Regex (
...
{- | Fields :
         ...
         * 'Proto.Envoy.Type.Matcher.Regex_Fields.pattern'' @:: Lens' RegexMatchAndSubstitute RegexMatcher@
         * 'Proto.Envoy.Type.Matcher.Regex_Fields.maybe'pattern'' @:: Lens' RegexMatchAndSubstitute (Prelude.Maybe RegexMatcher)@
         * 'Proto.Envoy.Type.Matcher.Regex_Fields.substitution' @:: Lens' RegexMatchAndSubstitute Data.Text.Text@ -}
...
instance Data.ProtoLens.Message RegexMatchAndSubstitute where
  messageName _
    = Data.Text.pack "envoy.type.matcher.RegexMatchAndSubstitute"
  packedMessageDescriptor _
    = "\n\
      \\ETBRegexMatchAndSubstitute\DC2:\n\
      \\apattern\CAN\SOH \SOH(\v2 .envoy.type.matcher.RegexMatcherR\apattern\DC2\"\n\
      \\fsubstitution\CAN\STX \SOH(\tR\fsubstitution"
...
{- | Fields :
         ...
         * 'Proto.Envoy.Type.Matcher.Regex_Fields.regex' @:: Lens' RegexMatcher Data.Text.Text@
         * 'Proto.Envoy.Type.Matcher.Regex_Fields.maybe'engineType' @:: Lens' RegexMatcher (Prelude.Maybe RegexMatcher'EngineType)@
         * 'Proto.Envoy.Type.Matcher.Regex_Fields.maybe'googleRe2' @:: Lens' RegexMatcher (Prelude.Maybe RegexMatcher'GoogleRE2)@
         * 'Proto.Envoy.Type.Matcher.Regex_Fields.googleRe2' @:: Lens' RegexMatcher RegexMatcher'GoogleRE2@ -}
data RegexMatcher
...
instance Data.ProtoLens.Message RegexMatcher where
  messageName _ = Data.Text.pack "envoy.type.matcher.RegexMatcher"
  packedMessageDescriptor _
    = "\n\
      \\fRegexMatcher\DC2U\n\
      \\n\
      \google_re2\CAN\SOH \SOH(\v2*.envoy.type.matcher.RegexMatcher.GoogleRE2H\NULR\tgoogleRe2B\b\250B\ENQ\138\SOH\STX\DLE\SOH\DC2\GS\n\
      \\ENQregex\CAN\STX \SOH(\tR\ENQregexB\a\250B\EOTr\STX\DLE\SOH\SUBW\n\
      \\tGoogleRE2\DC2J\n\
      \\DLEmax_program_size\CAN\SOH \SOH(\v2\FS.google.protobuf.UInt32ValueR\SOmaxProgramSizeB\STX\CAN\SOHB\DC2\n\
      \\vengine_type\DC2\ETX\248B\SOH"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
{- | Fields :
         ...
         * 'Proto.Envoy.Type.Matcher.Regex_Fields.maxProgramSize' @:: Lens' RegexMatcher'GoogleRE2 Proto.Google.Protobuf.Wrappers.UInt32Value@
         * 'Proto.Envoy.Type.Matcher.Regex_Fields.maybe'maxProgramSize' @:: Lens' RegexMatcher'GoogleRE2 (Prelude.Maybe Proto.Google.Protobuf.Wrappers.UInt32Value)@ -}
...
instance Data.ProtoLens.Message RegexMatcher'GoogleRE2 where
  messageName _
    = Data.Text.pack "envoy.type.matcher.RegexMatcher.GoogleRE2"
  packedMessageDescriptor _
    = "\n\
      \\tGoogleRE2\DC2J\n\
      \\DLEmax_program_size\CAN\SOH \SOH(\v2\FS.google.protobuf.UInt32ValueR\SOmaxProgramSizeB\STX\CAN\SOH"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
packedFileDescriptor
  = "\n\
    \\RSenvoy/type/matcher/regex.proto\DC2\DC2envoy.type.matcher\SUB\RSgoogle/protobuf/wrappers.proto\SUB\GSudpa/annotations/status.proto\SUB\ETBvalidate/validate.proto\"\241\SOH\n\
    \\fRegexMatcher\DC2U\n\
    \\n\
    \google_re2\CAN\SOH \SOH(\v2*.envoy.type.matcher.RegexMatcher.GoogleRE2H\NULR\tgoogleRe2B\b\250B\ENQ\138\SOH\STX\DLE\SOH\DC2\GS\n\
    \\ENQregex\CAN\STX \SOH(\tR\ENQregexB\a\250B\EOTr\STX\DLE\SOH\SUBW\n\
    \\tGoogleRE2\DC2J\n\
    \\DLEmax_program_size\CAN\SOH \SOH(\v2\FS.google.protobuf.UInt32ValueR\SOmaxProgramSizeB\STX\CAN\SOHB\DC2\n\
    \\vengine_type\DC2\ETX\248B\SOH\"y\n\
    \\ETBRegexMatchAndSubstitute\DC2:\n\
    \\apattern\CAN\SOH \SOH(\v2 .envoy.type.matcher.RegexMatcherR\apattern\DC2\"\n\
    \\fsubstitution\CAN\STX \SOH(\tR\fsubstitutionB8\n\
    \ io.envoyproxy.envoy.type.matcherB\n\
    \RegexProtoP\SOH\186\128\200\209\ACK\STX\DLE\SOHJ\241\FS\n\
    ...
    \u\n\
    \\STX\EOT\NUL\DC2\EOT\DC1\NUL3\SOH\SUBE A regex matcher designed for safety when used with untrusted input.\n\
    ...
    \\233\a\n\
    \\EOT\EOT\NUL\ETX\NUL\DC2\EOT\US\STX(\ETX\SUB\218\a Google's `RE2 <https://github.com/google/re2>`_ regex engine. The regex string must adhere to\n\
    ...
    \\DC3\n\
    \\243\ETX\n\
    \\ACK\EOT\NUL\ETX\NUL\STX\NUL\DC2\ETX'\EOTI\SUB\227\ETX This field controls the RE2 \"program size\" which is a rough estimate of how complex a\n\
    ...
    \\SO\n\
    \\a\EOT\NUL\ETX\NUL\STX\NUL\b\DC2\ETX'5H\n\
    \\SI\n\
    \\b\EOT\NUL\ETX\NUL\STX\NUL\b\ETX\DC2\ETX'6G\n\
    \\f\n\
    ...
    \)\n\
    \\EOT\EOT\NUL\STX\NUL\DC2\ETX.\EOTK\SUB\FS Google's RE2 regex engine.\n\
    \\n\
    \\f\n\
    ...
    \\f\n\
    \\ENQ\EOT\NUL\STX\NUL\b\DC2\ETX.\GSJ\n\
    \\SI\n\
    \\b\EOT\NUL\STX\NUL\b\175\b\DC1\DC2\ETX.\RSI\n\
    \]\n\
    \\EOT\EOT\NUL\STX\SOH\DC2\ETX2\STX<\SUBP The regex match string. The string must be supported by the configured engine.\n\
    \\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\SOH\ENQ\DC2\ETX2\STX\b\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\SOH\SOH\DC2\ETX2\t\SO\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\SOH\ETX\DC2\ETX2\DC1\DC2\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\SOH\b\DC2\ETX2\DC3;\n\
    \\SI\n\
    \\b\EOT\NUL\STX\SOH\b\175\b\SO\DC2\ETX2\DC4:\n\
    \\130\SOH\n\
    \\STX\EOT\SOH\DC2\EOT7\NULM\SOH\SUBv Describes how to match a string and then produce a new string using a regular\n\
    \ expression and a substitution string.\n\
    \\n\
    \\n\
    \\n\
    \\ETX\EOT\SOH\SOH\DC2\ETX7\b\US\n\
    \\131\ENQ\n\
    \\EOT\EOT\SOH\STX\NUL\DC2\ETXA\STX\ESC\SUB\245\EOT The regular expression used to find portions of a string (hereafter called\n\
    ...
    \\f\n\
    \\ENQ\EOT\SOH\STX\NUL\SOH\DC2\ETXA\SI\SYN\n\
    \\f\n\
    \\ENQ\EOT\SOH\STX\NUL\ETX\DC2\ETXA\EM\SUB\n\
    \\212\EOT\n\
    \\EOT\EOT\SOH\STX\SOH\DC2\ETXL\STX\SUB\SUB\198\EOT The string that should be substituted into matching portions of the\n\
    ...
    \\f\n\
    \\ENQ\EOT\SOH\STX\SOH\SOH\DC2\ETXL\t\NAK\n\
    \\f\n\
    \\ENQ\EOT\SOH\STX\SOH\ETX\DC2\ETXL\CAN\EMb\ACKproto3"