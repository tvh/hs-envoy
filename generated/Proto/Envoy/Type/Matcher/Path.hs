{- This file was auto-generated from envoy/type/matcher/path.proto by the proto-lens-protoc program. -}
{-# LANGUAGE ScopedTypeVariables, DataKinds, TypeFamilies, UndecidableInstances, GeneralizedNewtypeDeriving, MultiParamTypeClasses, FlexibleContexts, FlexibleInstances, PatternSynonyms, MagicHash, NoImplicitPrelude, DataKinds, BangPatterns, TypeApplications, OverloadedStrings, DerivingStrategies#-}
{-# OPTIONS_GHC -Wno-unused-imports#-}
{-# OPTIONS_GHC -Wno-duplicate-exports#-}
{-# OPTIONS_GHC -Wno-dodgy-exports#-}
module Proto.Envoy.Type.Matcher.Path (
...
{- | Fields :
         ...
         * 'Proto.Envoy.Type.Matcher.Path_Fields.maybe'rule' @:: Lens' PathMatcher (Prelude.Maybe PathMatcher'Rule)@
         * 'Proto.Envoy.Type.Matcher.Path_Fields.maybe'path' @:: Lens' PathMatcher (Prelude.Maybe Proto.Envoy.Type.Matcher.String.StringMatcher)@
         * 'Proto.Envoy.Type.Matcher.Path_Fields.path' @:: Lens' PathMatcher Proto.Envoy.Type.Matcher.String.StringMatcher@ -}
data PathMatcher
...
data PathMatcher'Rule
  = PathMatcher'Path !Proto.Envoy.Type.Matcher.String.StringMatcher
...
instance Data.ProtoLens.Field.HasField PathMatcher "maybe'rule" (Prelude.Maybe PathMatcher'Rule) where
  fieldOf _
    = (Prelude..)
        ...
        Prelude.id
instance Data.ProtoLens.Field.HasField PathMatcher "maybe'path" (Prelude.Maybe Proto.Envoy.Type.Matcher.String.StringMatcher) where
  fieldOf _
    = (Prelude..)
        (Lens.Family2.Unchecked.lens
           _PathMatcher'rule (\ x__ y__ -> x__ {_PathMatcher'rule = y__}))
...
instance Data.ProtoLens.Field.HasField PathMatcher "path" Proto.Envoy.Type.Matcher.String.StringMatcher where
  fieldOf _
    = (Prelude..)
        (Lens.Family2.Unchecked.lens
           _PathMatcher'rule (\ x__ y__ -> x__ {_PathMatcher'rule = y__}))
...
instance Data.ProtoLens.Message PathMatcher where
  messageName _ = Data.Text.pack "envoy.type.matcher.PathMatcher"
  packedMessageDescriptor _
    = "\n\
      \\vPathMatcher\DC2A\n\
      \\EOTpath\CAN\SOH \SOH(\v2!.envoy.type.matcher.StringMatcherH\NULR\EOTpathB\b\250B\ENQ\138\SOH\STX\DLE\SOHB\v\n\
...
_PathMatcher'Path ::
  Data.ProtoLens.Prism.Prism' PathMatcher'Rule Proto.Envoy.Type.Matcher.String.StringMatcher
_PathMatcher'Path
...
packedFileDescriptor
  = "\n\
    \\GSenvoy/type/matcher/path.proto\DC2\DC2envoy.type.matcher\SUB\USenvoy/type/matcher/string.proto\SUB\GSudpa/annotations/status.proto\SUB\ETBvalidate/validate.proto\"]\n\
    \\vPathMatcher\DC2A\n\
    \\EOTpath\CAN\SOH \SOH(\v2!.envoy.type.matcher.StringMatcherH\NULR\EOTpathB\b\250B\ENQ\138\SOH\STX\DLE\SOHB\v\n\
    \\EOTrule\DC2\ETX\248B\SOHB7\n\
    \ io.envoyproxy.envoy.type.matcherB\tPathProtoP\SOH\186\128\200\209\ACK\STX\DLE\SOHJ\135\ENQ\n\
    ...
    \c\n\
    \\STX\EOT\NUL\DC2\EOT\DC1\NUL\SUB\SOH\SUB4 Specifies the way to match a path on HTTP request.\n\
    ...
    \\f\n\
    \\EOT\EOT\NUL\b\NUL\DC2\EOT\DC2\STX\EM\ETX\n\
    \\f\n\
    \\ENQ\EOT\NUL\b\NUL\SOH\DC2\ETX\DC2\b\f\n\
    \\f\n\
    \\ENQ\EOT\NUL\b\NUL\STX\DC2\ETX\DC3\EOT&\n\
    \\SO\n\
    \\a\EOT\NUL\b\NUL\STX\175\b\DC2\ETX\DC3\EOT&\n\
    \\251\SOH\n\
    \\EOT\EOT\NUL\STX\NUL\DC2\ETX\CAN\EOTI\SUB\237\SOH The `path` must match the URL path portion of the :path header. The query and fragment\n\
    \ string (if present) are removed in the URL path portion.\n\
    \ For example, the path */data* will match the *:path* header */data#fragment?param=value*.\n\
    \\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\NUL\ACK\DC2\ETX\CAN\EOT\DC1\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\NUL\SOH\DC2\ETX\CAN\DC2\SYN\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\NUL\ETX\DC2\ETX\CAN\EM\SUB\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\NUL\b\DC2\ETX\CAN\ESCH\n\
    \\SI\n\
    \\b\EOT\NUL\STX\NUL\b\175\b\DC1\DC2\ETX\CAN\FSGb\ACKproto3"