{- This file was auto-generated from envoy/type/matcher/v3/number.proto by the proto-lens-protoc program. -}
{-# LANGUAGE ScopedTypeVariables, DataKinds, TypeFamilies, UndecidableInstances, GeneralizedNewtypeDeriving, MultiParamTypeClasses, FlexibleContexts, FlexibleInstances, PatternSynonyms, MagicHash, NoImplicitPrelude, DataKinds, BangPatterns, TypeApplications, OverloadedStrings, DerivingStrategies#-}
{-# OPTIONS_GHC -Wno-unused-imports#-}
{-# OPTIONS_GHC -Wno-duplicate-exports#-}
{-# OPTIONS_GHC -Wno-dodgy-exports#-}
module Proto.Envoy.Type.Matcher.V3.Number (
...
{- | Fields :
         ...
         * 'Proto.Envoy.Type.Matcher.V3.Number_Fields.maybe'matchPattern' @:: Lens' DoubleMatcher (Prelude.Maybe DoubleMatcher'MatchPattern)@
         * 'Proto.Envoy.Type.Matcher.V3.Number_Fields.maybe'range' @:: Lens' DoubleMatcher (Prelude.Maybe Proto.Envoy.Type.V3.Range.DoubleRange)@
         * 'Proto.Envoy.Type.Matcher.V3.Number_Fields.range' @:: Lens' DoubleMatcher Proto.Envoy.Type.V3.Range.DoubleRange@
         * 'Proto.Envoy.Type.Matcher.V3.Number_Fields.maybe'exact' @:: Lens' DoubleMatcher (Prelude.Maybe Prelude.Double)@
         * 'Proto.Envoy.Type.Matcher.V3.Number_Fields.exact' @:: Lens' DoubleMatcher Prelude.Double@ -}
data DoubleMatcher
...
data DoubleMatcher'MatchPattern
  = DoubleMatcher'Range !Proto.Envoy.Type.V3.Range.DoubleRange |
...
instance Data.ProtoLens.Field.HasField DoubleMatcher "maybe'matchPattern" (Prelude.Maybe DoubleMatcher'MatchPattern) where
  fieldOf _
    = (Prelude..)
        ...
        Prelude.id
instance Data.ProtoLens.Field.HasField DoubleMatcher "maybe'range" (Prelude.Maybe Proto.Envoy.Type.V3.Range.DoubleRange) where
  fieldOf _
    = (Prelude..)
        (Lens.Family2.Unchecked.lens
           _DoubleMatcher'matchPattern
...
instance Data.ProtoLens.Field.HasField DoubleMatcher "range" Proto.Envoy.Type.V3.Range.DoubleRange where
  fieldOf _
    = (Prelude..)
        (Lens.Family2.Unchecked.lens
           _DoubleMatcher'matchPattern
...
instance Data.ProtoLens.Message DoubleMatcher where
  messageName _
    = Data.Text.pack "envoy.type.matcher.v3.DoubleMatcher"
  packedMessageDescriptor _
    = "\n\
      \\rDoubleMatcher\DC22\n\
      \\ENQrange\CAN\SOH \SOH(\v2\SUB.envoy.type.v3.DoubleRangeH\NULR\ENQrange\DC2\SYN\n\
        ...
        range__field_descriptor
          = Data.ProtoLens.FieldDescriptor
              ...
              (Data.ProtoLens.MessageField Data.ProtoLens.MessageType ::
                 Data.ProtoLens.FieldTypeDescriptor Proto.Envoy.Type.V3.Range.DoubleRange)
...
_DoubleMatcher'Range ::
  Data.ProtoLens.Prism.Prism' DoubleMatcher'MatchPattern Proto.Envoy.Type.V3.Range.DoubleRange
_DoubleMatcher'Range
...
packedFileDescriptor
  = "\n\
    \\"envoy/type/matcher/v3/number.proto\DC2\NAKenvoy.type.matcher.v3\SUB\EMenvoy/type/v3/range.proto\SUB\GSudpa/annotations/status.proto\SUB!udpa/annotations/versioning.proto\SUB\ETBvalidate/validate.proto\"\154\SOH\n\
    \\rDoubleMatcher\DC22\n\
    \\ENQrange\CAN\SOH \SOH(\v2\SUB.envoy.type.v3.DoubleRangeH\NULR\ENQrange\DC2\SYN\n\
    \\ENQexact\CAN\STX \SOH(\SOHH\NULR\ENQexactB\DC4\n\
    \\rmatch_pattern\DC2\ETX\248B\SOH:'\154\197\136\RS\"\n\
    \ envoy.type.matcher.DoubleMatcherB<\n\
    \#io.envoyproxy.envoy.type.matcher.v3B\vNumberProtoP\SOH\186\128\200\209\ACK\STX\DLE\STXJ\183\ENQ\n\
    ...
    \]\n\
    \\STX\EOT\NUL\DC2\EOT\DC2\NUL\US\SOH\SUB, Specifies the way to match a double value.\n\
    ...
    \\n\
    \\n\
    \\ETX\EOT\NUL\a\DC2\ETX\DC3\STXb\n\
    \\SI\n\
    \\b\EOT\NUL\a\211\136\225\ETX\SOH\DC2\ETX\DC3\STXb\n\
    \\f\n\
    \\EOT\EOT\NUL\b\NUL\DC2\EOT\NAK\STX\RS\ETX\n\
    \\f\n\
    \\ENQ\EOT\NUL\b\NUL\SOH\DC2\ETX\NAK\b\NAK\n\
    \\f\n\
    \\ENQ\EOT\NUL\b\NUL\STX\DC2\ETX\SYN\EOT&\n\
    \\SO\n\
    \\a\EOT\NUL\b\NUL\STX\175\b\DC2\ETX\SYN\EOT&\n\
    \\158\SOH\n\
    \\EOT\EOT\NUL\STX\NUL\DC2\ETX\SUB\EOT\"\SUB\144\SOH If specified, the input double value must be in the range specified here.\n\
    \ Note: The range is using half-open interval semantics [start, end).\n\
    \\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\NUL\ACK\DC2\ETX\SUB\EOT\ETB\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\NUL\SOH\DC2\ETX\SUB\CAN\GS\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\NUL\ETX\DC2\ETX\SUB !\n\
    \^\n\
    \\EOT\EOT\NUL\STX\SOH\DC2\ETX\GS\EOT\NAK\SUBQ If specified, the input double value must be equal to the value specified here.\n\
    \\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\SOH\ENQ\DC2\ETX\GS\EOT\n\
    \\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\SOH\SOH\DC2\ETX\GS\v\DLE\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\SOH\ETX\DC2\ETX\GS\DC3\DC4b\ACKproto3"