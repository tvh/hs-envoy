...
module Proto.Envoy.Type.Matcher.V3.Node_Fields where
...
nodeMetadatas ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "nodeMetadatas" a) =>
  Lens.Family2.LensLike' f s a
nodeMetadatas = Data.ProtoLens.Field.field @"nodeMetadatas"
vec'nodeMetadatas ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "vec'nodeMetadatas" a) =>
  Lens.Family2.LensLike' f s a
vec'nodeMetadatas = Data.ProtoLens.Field.field @"vec'nodeMetadatas"