...
module Proto.Envoy.Type.Matcher.Value (
...
{- | Fields :
         ...
         * 'Proto.Envoy.Type.Matcher.Value_Fields.maybe'matchPattern' @:: Lens' ListMatcher (Prelude.Maybe ListMatcher'MatchPattern)@
         * 'Proto.Envoy.Type.Matcher.Value_Fields.maybe'oneOf' @:: Lens' ListMatcher (Prelude.Maybe ValueMatcher)@
         * 'Proto.Envoy.Type.Matcher.Value_Fields.oneOf' @:: Lens' ListMatcher ValueMatcher@ -}
data ListMatcher
...
instance Data.ProtoLens.Message ListMatcher where
  messageName _ = Data.Text.pack "envoy.type.matcher.ListMatcher"
  packedMessageDescriptor _
    = "\n\
      \\vListMatcher\DC29\n\
      \\ACKone_of\CAN\SOH \SOH(\v2 .envoy.type.matcher.ValueMatcherH\NULR\ENQoneOfB\DC4\n\
...
{- | Fields :
         ...
         * 'Proto.Envoy.Type.Matcher.Value_Fields.maybe'matchPattern' @:: Lens' ValueMatcher (Prelude.Maybe ValueMatcher'MatchPattern)@
         * 'Proto.Envoy.Type.Matcher.Value_Fields.maybe'nullMatch' @:: Lens' ValueMatcher (Prelude.Maybe ValueMatcher'NullMatch)@
         * 'Proto.Envoy.Type.Matcher.Value_Fields.nullMatch' @:: Lens' ValueMatcher ValueMatcher'NullMatch@
         * 'Proto.Envoy.Type.Matcher.Value_Fields.maybe'doubleMatch' @:: Lens' ValueMatcher (Prelude.Maybe Proto.Envoy.Type.Matcher.Number.DoubleMatcher)@
         * 'Proto.Envoy.Type.Matcher.Value_Fields.doubleMatch' @:: Lens' ValueMatcher Proto.Envoy.Type.Matcher.Number.DoubleMatcher@
         * 'Proto.Envoy.Type.Matcher.Value_Fields.maybe'stringMatch' @:: Lens' ValueMatcher (Prelude.Maybe Proto.Envoy.Type.Matcher.String.StringMatcher)@
         * 'Proto.Envoy.Type.Matcher.Value_Fields.stringMatch' @:: Lens' ValueMatcher Proto.Envoy.Type.Matcher.String.StringMatcher@
         * 'Proto.Envoy.Type.Matcher.Value_Fields.maybe'boolMatch' @:: Lens' ValueMatcher (Prelude.Maybe Prelude.Bool)@
         * 'Proto.Envoy.Type.Matcher.Value_Fields.boolMatch' @:: Lens' ValueMatcher Prelude.Bool@
         * 'Proto.Envoy.Type.Matcher.Value_Fields.maybe'presentMatch' @:: Lens' ValueMatcher (Prelude.Maybe Prelude.Bool)@
         * 'Proto.Envoy.Type.Matcher.Value_Fields.presentMatch' @:: Lens' ValueMatcher Prelude.Bool@
         * 'Proto.Envoy.Type.Matcher.Value_Fields.maybe'listMatch' @:: Lens' ValueMatcher (Prelude.Maybe ListMatcher)@
         * 'Proto.Envoy.Type.Matcher.Value_Fields.listMatch' @:: Lens' ValueMatcher ListMatcher@ -}
data ValueMatcher
...
data ValueMatcher'MatchPattern
  = ValueMatcher'NullMatch' !ValueMatcher'NullMatch |
    ValueMatcher'DoubleMatch !Proto.Envoy.Type.Matcher.Number.DoubleMatcher |
    ValueMatcher'StringMatch !Proto.Envoy.Type.Matcher.String.StringMatcher |
    ...
    = (Prelude..)
        ...
        ((Prelude..)
           (Lens.Family2.Unchecked.lens
              ...
              (\ _ y__ -> Prelude.fmap ValueMatcher'NullMatch' y__))
           (Data.ProtoLens.maybeLens Data.ProtoLens.defMessage))
instance Data.ProtoLens.Field.HasField ValueMatcher "maybe'doubleMatch" (Prelude.Maybe Proto.Envoy.Type.Matcher.Number.DoubleMatcher) where
  fieldOf _
    = (Prelude..)
        (Lens.Family2.Unchecked.lens
           _ValueMatcher'matchPattern
...
instance Data.ProtoLens.Field.HasField ValueMatcher "doubleMatch" Proto.Envoy.Type.Matcher.Number.DoubleMatcher where
  fieldOf _
    = (Prelude..)
        (Lens.Family2.Unchecked.lens
           _ValueMatcher'matchPattern
        ...
        ((Prelude..)
           (Lens.Family2.Unchecked.lens
              ...
              (\ _ y__ -> Prelude.fmap ValueMatcher'DoubleMatch y__))
           (Data.ProtoLens.maybeLens Data.ProtoLens.defMessage))
instance Data.ProtoLens.Field.HasField ValueMatcher "maybe'stringMatch" (Prelude.Maybe Proto.Envoy.Type.Matcher.String.StringMatcher) where
  fieldOf _
    = (Prelude..)
        (Lens.Family2.Unchecked.lens
           _ValueMatcher'matchPattern
...
instance Data.ProtoLens.Field.HasField ValueMatcher "stringMatch" Proto.Envoy.Type.Matcher.String.StringMatcher where
  fieldOf _
    = (Prelude..)
        (Lens.Family2.Unchecked.lens
           _ValueMatcher'matchPattern
...
instance Data.ProtoLens.Message ValueMatcher where
  messageName _ = Data.Text.pack "envoy.type.matcher.ValueMatcher"
  packedMessageDescriptor _
    = "\n\
      \\fValueMatcher\DC2K\n\
      \\n\
      \null_match\CAN\SOH \SOH(\v2*.envoy.type.matcher.ValueMatcher.NullMatchH\NULR\tnullMatch\DC2F\n\
      \\fdouble_match\CAN\STX \SOH(\v2!.envoy.type.matcher.DoubleMatcherH\NULR\vdoubleMatch\DC2F\n\
      \\fstring_match\CAN\ETX \SOH(\v2!.envoy.type.matcher.StringMatcherH\NULR\vstringMatch\DC2\US\n\
      \\n\
      \bool_match\CAN\EOT \SOH(\bH\NULR\tboolMatch\DC2%\n\
      \\rpresent_match\CAN\ENQ \SOH(\bH\NULR\fpresentMatch\DC2@\n\
      \\n\
      \list_match\CAN\ACK \SOH(\v2\US.envoy.type.matcher.ListMatcherH\NULR\tlistMatch\SUB\v\n\
      \\tNullMatchB\DC4\n\
      \\rmatch_pattern\DC2\ETX\248B\SOH"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
        ...
        doubleMatch__field_descriptor
          = Data.ProtoLens.FieldDescriptor
              "double_match"
              (Data.ProtoLens.MessageField Data.ProtoLens.MessageType ::
                 Data.ProtoLens.FieldTypeDescriptor Proto.Envoy.Type.Matcher.Number.DoubleMatcher)
              (Data.ProtoLens.OptionalField
...
_ValueMatcher'DoubleMatch ::
  Data.ProtoLens.Prism.Prism' ValueMatcher'MatchPattern Proto.Envoy.Type.Matcher.Number.DoubleMatcher
_ValueMatcher'DoubleMatch
  = Data.ProtoLens.Prism.prism'
...
_ValueMatcher'StringMatch ::
  Data.ProtoLens.Prism.Prism' ValueMatcher'MatchPattern Proto.Envoy.Type.Matcher.String.StringMatcher
_ValueMatcher'StringMatch
  = Data.ProtoLens.Prism.prism'
...
instance Data.ProtoLens.Message ValueMatcher'NullMatch where
  messageName _
    = Data.Text.pack "envoy.type.matcher.ValueMatcher.NullMatch"
  packedMessageDescriptor _
    = "\n\
      \\tNullMatch"
  packedFileDescriptor _ = packedFileDescriptor
...
packedFileDescriptor
  = "\n\
    \\RSenvoy/type/matcher/value.proto\DC2\DC2envoy.type.matcher\SUB\USenvoy/type/matcher/number.proto\SUB\USenvoy/type/matcher/string.proto\SUB\GSudpa/annotations/status.proto\SUB\ETBvalidate/validate.proto\"\152\ETX\n\
    \\fValueMatcher\DC2K\n\
    \\n\
    \null_match\CAN\SOH \SOH(\v2*.envoy.type.matcher.ValueMatcher.NullMatchH\NULR\tnullMatch\DC2F\n\
    \\fdouble_match\CAN\STX \SOH(\v2!.envoy.type.matcher.DoubleMatcherH\NULR\vdoubleMatch\DC2F\n\
    ...
    \\vListMatcher\DC29\n\
    \\ACKone_of\CAN\SOH \SOH(\v2 .envoy.type.matcher.ValueMatcherH\NULR\ENQoneOfB\DC4\n\
    \\rmatch_pattern\DC2\ETX\248B\SOHB8\n\
    \ io.envoyproxy.envoy.type.matcherB\n\
    \ValueProtoP\SOH\186\128\200\209\ACK\STX\DLE\SOHJ\131\SI\n\
    ...
    \\225\SOH\n\
    \\STX\EOT\NUL\DC2\EOT\DC4\NUL5\SOH\SUB\176\SOH Specifies the way to match a ProtobufWkt::Value. Primitive values and ListValue are supported.\n\
    ...
    \F\n\
    \\EOT\EOT\NUL\ETX\NUL\DC2\EOT\SYN\STX\ETB\ETX\SUB8 NullMatch is an empty message to specify a null value.\n\
    \\n\
    \\f\n\
    \\ENQ\EOT\NUL\ETX\NUL\SOH\DC2\ETX\SYN\n\
    \\DC3\n\
    \/\n\
    \\EOT\EOT\NUL\b\NUL\DC2\EOT\SUB\STX4\ETX\SUB! Specifies how to match a value.\n\
    \\n\
    \\f\n\
    ...
    \[\n\
    \\EOT\EOT\NUL\STX\NUL\DC2\ETX\RS\EOT\GS\SUBN If specified, a match occurs if and only if the target value is a NullValue.\n\
    \\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\NUL\ACK\DC2\ETX\RS\EOT\r\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\NUL\SOH\DC2\ETX\RS\SO\CAN\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\NUL\ETX\DC2\ETX\RS\ESC\FS\n\
    \|\n\
    ...
    \\229\SOH\n\
    \\EOT\EOT\NUL\STX\EOT\DC2\ETX/\EOT\ESC\SUB\215\SOH If specified, value match will be performed based on whether the path is referring to a\n\
    \ valid primitive value in the metadata. If the path is referring to a non-primitive value,\n\
    \ the result is always not matched.\n\
    \\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\EOT\ENQ\DC2\ETX/\EOT\b\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\EOT\SOH\DC2\ETX/\t\SYN\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\EOT\ETX\DC2\ETX/\EM\SUB\n\
    \z\n\
    \\EOT\EOT\NUL\STX\ENQ\DC2\ETX3\EOT\US\SUBm If specified, a match occurs if and only if the target value is a list value and\n\
    \ is matched to this field.\n\
    \\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\ENQ\ACK\DC2\ETX3\EOT\SI\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\ENQ\SOH\DC2\ETX3\DLE\SUB\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\ENQ\ETX\DC2\ETX3\GS\RS\n\
    \6\n\
    \\STX\EOT\SOH\DC2\EOT8\NUL?\SOH\SUB* Specifies the way to match a list value.\n\
    \\n\
    \\n\
    \\n\
    \\ETX\EOT\SOH\SOH\DC2\ETX8\b\DC3\n\
    \\f\n\
    \\EOT\EOT\SOH\b\NUL\DC2\EOT9\STX>\ETX\n\
    \\f\n\
    \\ENQ\EOT\SOH\b\NUL\SOH\DC2\ETX9\b\NAK\n\
    \\f\n\
    \\ENQ\EOT\SOH\b\NUL\STX\DC2\ETX:\EOT&\n\
    \\SO\n\
    \\a\EOT\SOH\b\NUL\STX\175\b\DC2\ETX:\EOT&\n\
    \c\n\
    \\EOT\EOT\SOH\STX\NUL\DC2\ETX=\EOT\FS\SUBV If specified, at least one of the values in the list must match the value specified.\n\
    \\n\
    \\f\n\
    \\ENQ\EOT\SOH\STX\NUL\ACK\DC2\ETX=\EOT\DLE\n\
    \\f\n\
    \\ENQ\EOT\SOH\STX\NUL\SOH\DC2\ETX=\DC1\ETB\n\
    \\f\n\
    \\ENQ\EOT\SOH\STX\NUL\ETX\DC2\ETX=\SUB\ESCb\ACKproto3"