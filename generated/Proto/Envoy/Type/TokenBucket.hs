...
module Proto.Envoy.Type.TokenBucket (
        TokenBucket()
    ) where
...
{- | Fields :
         ...
         * 'Proto.Envoy.Type.TokenBucket_Fields.maxTokens' @:: Lens' TokenBucket Data.Word.Word32@
         * 'Proto.Envoy.Type.TokenBucket_Fields.tokensPerFill' @:: Lens' TokenBucket Proto.Google.Protobuf.Wrappers.UInt32Value@
         * 'Proto.Envoy.Type.TokenBucket_Fields.maybe'tokensPerFill' @:: Lens' TokenBucket (Prelude.Maybe Proto.Google.Protobuf.Wrappers.UInt32Value)@
         * 'Proto.Envoy.Type.TokenBucket_Fields.fillInterval' @:: Lens' TokenBucket Proto.Google.Protobuf.Duration.Duration@
         * 'Proto.Envoy.Type.TokenBucket_Fields.maybe'fillInterval' @:: Lens' TokenBucket (Prelude.Maybe Proto.Google.Protobuf.Duration.Duration)@ -}
data TokenBucket
...
instance Data.ProtoLens.Message TokenBucket where
  messageName _ = Data.Text.pack "envoy.type.TokenBucket"
...
packedFileDescriptor
  = "\n\
    \\GSenvoy/type/token_bucket.proto\DC2\n\
    \envoy.type\SUB\RSgoogle/protobuf/duration.proto\SUB\RSgoogle/protobuf/wrappers.proto\SUB\GSudpa/annotations/status.proto\SUB\ETBvalidate/validate.proto\"\208\SOH\n\
    \\vTokenBucket\DC2&\n\
    \\n\
    \max_tokens\CAN\SOH \SOH(\rR\tmaxTokensB\a\250B\EOT*\STX \NUL\DC2M\n\
    \\SItokens_per_fill\CAN\STX \SOH(\v2\FS.google.protobuf.UInt32ValueR\rtokensPerFillB\a\250B\EOT*\STX \NUL\DC2J\n\
    \\rfill_interval\CAN\ETX \SOH(\v2\EM.google.protobuf.DurationR\ffillIntervalB\n\
    \\250B\a\170\SOH\EOT\b\SOH*\NULB6\n\
    \\CANio.envoyproxy.envoy.typeB\DLETokenBucketProtoP\SOH\186\128\200\209\ACK\STX\DLE\SOHJ\207\a\n\
    ...
    \m\n\
    \\STX\EOT\NUL\DC2\EOT\DC2\NUL\"\SOH\SUB> Configures a token bucket, typically used for rate limiting.\n\
    ...
    \\130\SOH\n\
    \\EOT\EOT\NUL\STX\NUL\DC2\ETX\NAK\STX<\SUBu The maximum tokens that the bucket can hold. This is also the number of tokens that the bucket\n\
    \ initially contains.\n\
    \\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\NUL\ENQ\DC2\ETX\NAK\STX\b\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\NUL\SOH\DC2\ETX\NAK\t\DC3\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\NUL\ETX\DC2\ETX\NAK\SYN\ETB\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\NUL\b\DC2\ETX\NAK\CAN;\n\
    \\SI\n\
    \\b\EOT\NUL\STX\NUL\b\175\b\ENQ\DC2\ETX\NAK\EM:\n\
    \\129\SOH\n\
    \\EOT\EOT\NUL\STX\SOH\DC2\ETX\EM\STXV\SUBt The number of tokens added to the bucket during each fill interval. If not specified, defaults\n\
    \ to a single token.\n\
    \\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\SOH\ACK\DC2\ETX\EM\STX\GS\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\SOH\SOH\DC2\ETX\EM\RS-\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\SOH\ETX\DC2\ETX\EM01\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\SOH\b\DC2\ETX\EM2U\n\
    \\SI\n\
    \\b\EOT\NUL\STX\SOH\b\175\b\ENQ\DC2\ETX\EM3T\n\
    \\203\SOH\n\
    \\EOT\EOT\NUL\STX\STX\DC2\EOT\RS\STX!\ENQ\SUB\188\SOH The fill interval that tokens are added to the bucket. During each fill interval\n\
    \ `tokens_per_fill` are added to the bucket. The bucket will never contain more than\n\
    \ `max_tokens` tokens.\n\
    \\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\STX\ACK\DC2\ETX\RS\STX\SUB\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\STX\SOH\DC2\ETX\RS\ESC(\n\
    \\f\n\
    \\ENQ\EOT\NUL\STX\STX\ETX\DC2\ETX\RS+,\n\
    \\r\n\
    \\ENQ\EOT\NUL\STX\STX\b\DC2\EOT\RS-!\EOT\n\
    \\DLE\n\
    \\b\EOT\NUL\STX\STX\b\175\b\NAK\DC2\EOT\RS.!\ETXb\ACKproto3"