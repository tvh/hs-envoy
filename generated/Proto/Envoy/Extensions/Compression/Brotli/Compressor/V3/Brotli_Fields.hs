...
module Proto.Envoy.Extensions.Compression.Brotli.Compressor.V3.Brotli_Fields where
...
disableLiteralContextModeling ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "disableLiteralContextModeling" a) =>
  Lens.Family2.LensLike' f s a
disableLiteralContextModeling
...
encoderMode ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "encoderMode" a) =>
  Lens.Family2.LensLike' f s a
encoderMode = Data.ProtoLens.Field.field @"encoderMode"
inputBlockBits ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "inputBlockBits" a) =>
  Lens.Family2.LensLike' f s a
inputBlockBits = Data.ProtoLens.Field.field @"inputBlockBits"
maybe'chunkSize ::
  forall f s a.
  (Prelude.Functor f,
...
maybe'inputBlockBits ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'inputBlockBits" a) =>
  Lens.Family2.LensLike' f s a
maybe'inputBlockBits
