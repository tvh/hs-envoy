...
module Proto.Envoy.Extensions.Common.Matching.V3.ExtensionMatcher_Fields where
...
extensionConfig ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "extensionConfig" a) =>
  Lens.Family2.LensLike' f s a
extensionConfig = Data.ProtoLens.Field.field @"extensionConfig"
matcher ::
  forall f s a.
  (Prelude.Functor f, Data.ProtoLens.Field.HasField s "matcher" a) =>
  Lens.Family2.LensLike' f s a
matcher = Data.ProtoLens.Field.field @"matcher"
maybe'extensionConfig ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'extensionConfig" a) =>
  Lens.Family2.LensLike' f s a
maybe'extensionConfig
