...
module Proto.Envoy.Extensions.Filters.Http.Ratelimit.V3.RateLimit_Fields where
...
disableXEnvoyRatelimitedHeader ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "disableXEnvoyRatelimitedHeader" a) =>
...
enableXRatelimitHeaders ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "enableXRatelimitHeaders" a) =>
  Lens.Family2.LensLike' f s a
enableXRatelimitHeaders
...
rateLimitedAsResourceExhausted ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "rateLimitedAsResourceExhausted" a) =>
  Lens.Family2.LensLike' f s a
rateLimitedAsResourceExhausted
...
vhRateLimits ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "vhRateLimits" a) =>
  Lens.Family2.LensLike' f s a
vhRateLimits = Data.ProtoLens.Field.field @"vhRateLimits"