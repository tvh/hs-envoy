...
module Proto.Envoy.Extensions.Filters.Http.Decompressor.V3.Decompressor_Fields where
...
advertiseAcceptEncoding ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "advertiseAcceptEncoding" a) =>
  Lens.Family2.LensLike' f s a
advertiseAcceptEncoding
  = Data.ProtoLens.Field.field @"advertiseAcceptEncoding"
commonConfig ::
  forall f s a.
  (Prelude.Functor f,
...
decompressorLibrary ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "decompressorLibrary" a) =>
  Lens.Family2.LensLike' f s a
decompressorLibrary
  = Data.ProtoLens.Field.field @"decompressorLibrary"
enabled ::
  forall f s a.
  (Prelude.Functor f, Data.ProtoLens.Field.HasField s "enabled" a) =>
  Lens.Family2.LensLike' f s a
enabled = Data.ProtoLens.Field.field @"enabled"
maybe'advertiseAcceptEncoding ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'advertiseAcceptEncoding" a) =>
  Lens.Family2.LensLike' f s a
maybe'advertiseAcceptEncoding
...
maybe'decompressorLibrary ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'decompressorLibrary" a) =>
  Lens.Family2.LensLike' f s a
maybe'decompressorLibrary
