...
module Proto.Envoy.Extensions.Filters.Http.BandwidthLimit.V3alpha.BandwidthLimit_Fields where
...
enableMode ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "enableMode" a) =>
  Lens.Family2.LensLike' f s a
enableMode = Data.ProtoLens.Field.field @"enableMode"
fillInterval ::
  forall f s a.
  (Prelude.Functor f,
...
maybe'limitKbps ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'limitKbps" a) =>
  Lens.Family2.LensLike' f s a
maybe'limitKbps = Data.ProtoLens.Field.field @"maybe'limitKbps"
