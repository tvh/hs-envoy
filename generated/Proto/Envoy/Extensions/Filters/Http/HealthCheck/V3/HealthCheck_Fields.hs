...
module Proto.Envoy.Extensions.Filters.Http.HealthCheck.V3.HealthCheck_Fields where
...
clusterMinHealthyPercentages ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "clusterMinHealthyPercentages" a) =>
  Lens.Family2.LensLike' f s a
clusterMinHealthyPercentages
...
maybe'passThroughMode ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'passThroughMode" a) =>
  Lens.Family2.LensLike' f s a
maybe'passThroughMode
...
passThroughMode ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "passThroughMode" a) =>
  Lens.Family2.LensLike' f s a
passThroughMode = Data.ProtoLens.Field.field @"passThroughMode"
value ::
  forall f s a.
