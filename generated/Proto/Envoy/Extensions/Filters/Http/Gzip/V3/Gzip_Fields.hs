...
module Proto.Envoy.Extensions.Filters.Http.Gzip.V3.Gzip_Fields where
...
maybe'compressor ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'compressor" a) =>
  Lens.Family2.LensLike' f s a
maybe'compressor = Data.ProtoLens.Field.field @"maybe'compressor"
maybe'memoryLevel ::
  forall f s a.
  (Prelude.Functor f,
