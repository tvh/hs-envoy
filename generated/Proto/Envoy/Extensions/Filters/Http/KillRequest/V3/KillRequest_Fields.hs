...
module Proto.Envoy.Extensions.Filters.Http.KillRequest.V3.KillRequest_Fields where
...
killRequestHeader ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "killRequestHeader" a) =>
  Lens.Family2.LensLike' f s a
killRequestHeader = Data.ProtoLens.Field.field @"killRequestHeader"
maybe'probability ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'probability" a) =>
  Lens.Family2.LensLike' f s a
maybe'probability = Data.ProtoLens.Field.field @"maybe'probability"
probability ::
  forall f s a.
  (Prelude.Functor f,
