...
module Proto.Envoy.Extensions.Filters.Http.AwsRequestSigning.V3.AwsRequestSigning_Fields where
...
hostRewrite ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "hostRewrite" a) =>
  Lens.Family2.LensLike' f s a
hostRewrite = Data.ProtoLens.Field.field @"hostRewrite"
region ::
  forall f s a.
...
useUnsignedPayload ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "useUnsignedPayload" a) =>
  Lens.Family2.LensLike' f s a
useUnsignedPayload
