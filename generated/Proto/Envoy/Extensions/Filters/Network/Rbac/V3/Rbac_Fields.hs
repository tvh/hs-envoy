...
module Proto.Envoy.Extensions.Filters.Network.Rbac.V3.Rbac_Fields where
...
enforcementType ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "enforcementType" a) =>
  Lens.Family2.LensLike' f s a
enforcementType = Data.ProtoLens.Field.field @"enforcementType"
maybe'rules ::
  forall f s a.
  (Prelude.Functor f,
