{- This file was auto-generated from envoy/extensions/filters/network/thrift_proxy/router/v3/router.proto by the proto-lens-protoc program. -}
{-# LANGUAGE ScopedTypeVariables, DataKinds, TypeFamilies, UndecidableInstances, GeneralizedNewtypeDeriving, MultiParamTypeClasses, FlexibleContexts, FlexibleInstances, PatternSynonyms, MagicHash, NoImplicitPrelude, DataKinds, BangPatterns, TypeApplications, OverloadedStrings, DerivingStrategies#-}
{-# OPTIONS_GHC -Wno-unused-imports#-}
{-# OPTIONS_GHC -Wno-duplicate-exports#-}
{-# OPTIONS_GHC -Wno-dodgy-exports#-}
module Proto.Envoy.Extensions.Filters.Network.ThriftProxy.Router.V3.Router (
        Router()
    ) where
...
packedFileDescriptor
  = "\n\
    \Denvoy/extensions/filters/network/thrift_proxy/router/v3/router.proto\DC27envoy.extensions.filters.network.thrift_proxy.router.v3\SUB\GSudpa/annotations/status.proto\SUB!udpa/annotations/versioning.proto\"B\n\
    \\ACKRouter:8\154\197\136\RS3\n\
    \1envoy.config.filter.thrift.router.v2alpha1.RouterB^\n\
    \Eio.envoyproxy.envoy.extensions.filters.network.thrift_proxy.router.v3B\vRouterProtoP\SOH\186\128\200\209\ACK\STX\DLE\STXJ\216\STX\n\
    ...
    \\NULF\n\
    \\160\SOH\n\
    \\STX\EOT\NUL\DC2\EOT\DLE\NUL\DC3\SOH2\147\SOH [#protodoc-title: Router]\n\
