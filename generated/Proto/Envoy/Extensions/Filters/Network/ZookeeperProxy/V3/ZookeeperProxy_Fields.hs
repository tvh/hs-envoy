...
module Proto.Envoy.Extensions.Filters.Network.ZookeeperProxy.V3.ZookeeperProxy_Fields where
...
maxPacketBytes ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maxPacketBytes" a) =>
  Lens.Family2.LensLike' f s a
maxPacketBytes = Data.ProtoLens.Field.field @"maxPacketBytes"
maybe'maxPacketBytes ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'maxPacketBytes" a) =>
  Lens.Family2.LensLike' f s a
maybe'maxPacketBytes
