...
module Proto.Envoy.Extensions.Filters.Network.ClientSslAuth.V3.ClientSslAuth_Fields where
...
authApiCluster ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "authApiCluster" a) =>
  Lens.Family2.LensLike' f s a
authApiCluster = Data.ProtoLens.Field.field @"authApiCluster"
ipWhiteList ::
  forall f s a.
  (Prelude.Functor f,
