...
module Proto.Envoy.Extensions.Http.OriginalIpDetection.CustomHeader.V3.CustomHeader_Fields where
...
allowExtensionToSetAddressAsTrusted ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "allowExtensionToSetAddressAsTrusted" a) =>
...
maybe'rejectWithStatus ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'rejectWithStatus" a) =>
  Lens.Family2.LensLike' f s a
maybe'rejectWithStatus
...
rejectWithStatus ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "rejectWithStatus" a) =>
  Lens.Family2.LensLike' f s a
rejectWithStatus = Data.ProtoLens.Field.field @"rejectWithStatus"