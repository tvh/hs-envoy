...
module Proto.Envoy.Extensions.TransportSockets.Tls.V3.Secret_Fields where
...
genericSecret ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "genericSecret" a) =>
  Lens.Family2.LensLike' f s a
genericSecret = Data.ProtoLens.Field.field @"genericSecret"
maybe'genericSecret ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'genericSecret" a) =>
  Lens.Family2.LensLike' f s a
maybe'genericSecret
...
maybe'sdsConfig ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'sdsConfig" a) =>
  Lens.Family2.LensLike' f s a
maybe'sdsConfig = Data.ProtoLens.Field.field @"maybe'sdsConfig"
maybe'secret ::
  forall f s a.
  (Prelude.Functor f,
...
maybe'tlsCertificate ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "maybe'tlsCertificate" a) =>
  Lens.Family2.LensLike' f s a
maybe'tlsCertificate
...
sdsConfig ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "sdsConfig" a) =>
  Lens.Family2.LensLike' f s a
sdsConfig = Data.ProtoLens.Field.field @"sdsConfig"
secret ::
  forall f s a.
...
tlsCertificate ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "tlsCertificate" a) =>
  Lens.Family2.LensLike' f s a
tlsCertificate = Data.ProtoLens.Field.field @"tlsCertificate"
validationContext ::
  forall f s a.
  (Prelude.Functor f,
