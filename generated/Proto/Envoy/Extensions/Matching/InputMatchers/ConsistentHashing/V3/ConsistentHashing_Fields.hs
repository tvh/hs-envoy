...
module Proto.Envoy.Extensions.Matching.InputMatchers.ConsistentHashing.V3.ConsistentHashing_Fields where
...
modulo ::
  forall f s a.
  (Prelude.Functor f, Data.ProtoLens.Field.HasField s "modulo" a) =>
  Lens.Family2.LensLike' f s a
modulo = Data.ProtoLens.Field.field @"modulo"
seed ::
  forall f s a.
