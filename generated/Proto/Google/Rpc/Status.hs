...
packedFileDescriptor
  = "\n\
    ...
    \\SOcom.google.rpcB\vStatusProtoP\SOHZ7google.golang.org/genproto/googleapis/rpc/status;status\248\SOH\SOH\162\STX\ETXRPCJ\130\SO\n\
    ...
    \d\n\
    \\EOT\EOT\NUL\STX\NUL\DC2\ETX$\STX\DC1\SUBW The status code, which should be an enum value of [google.rpc.Code][google.rpc.Code].\n\
    \\n\
    \\f\n\
    ...
    \\235\SOH\n\
    \\EOT\EOT\NUL\STX\SOH\DC2\ETX)\STX\NAK\SUB\221\SOH A developer-facing error message, which should be in English. Any\n\
