...
module Proto.Udpa.Annotations.Security_Fields where
...
configureForUntrustedDownstream ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "configureForUntrustedDownstream" a) =>
...
configureForUntrustedUpstream ::
  forall f s a.
  (Prelude.Functor f,
   Data.ProtoLens.Field.HasField s "configureForUntrustedUpstream" a) =>
  Lens.Family2.LensLike' f s a
configureForUntrustedUpstream
